  ...
  return (
    <main className="service-owner legal-page">
      ...
      <article className="legal-copy">
        <p className="eyebrow">LEGAL & TRUST</p><h1>Terms of Service</h1><p>Website information is general guidance. A service engagement begins only after both parties agree the scope, deliverables, timeline, fees, ownership and responsibilities in writing.</p>
