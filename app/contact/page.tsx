  ...
  return (
    <main className="service-owner contact-page">
      ...
      <section className="contact-options">
        <a href={WHATSAPP_URL}><span>FASTEST RESPONSE</span><h2>Start on WhatsApp</h2><p>Send your business name, website or Google listing and the service you are considering.</p><b>Open WhatsApp ↗</b></a>
        <a href={`tel:${CONTACT_PHONE}`}><span>CALL</span><h2>{CONTACT_PHONE}</h2><p>Call for a brief introductory conversation during normal India business hours.</p><b>Call now ↗</b></a>
